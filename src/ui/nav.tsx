    ...
    <nav className="nav bg-color-canvas w-full max-w-7xl mx-auto px-4 sm:px-8 pt-4">
      <div className="nav-logo flex items-center justify-between h-14">
        ...
        <div className="nav-links flex gap-6 ml-4 pb-4 border-b-4 border-[var(--color-accent)] w-full justify-end">
          <a href="https://x.com/tarinrickett" target="_blank" aria-label="Twitter">
            
          </a>
          <a href="https://github.com/tarinrickett" target="_blank" aria-label="GitHub">
